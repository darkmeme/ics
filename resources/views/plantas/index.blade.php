...
<div class="col-lg-6 col-xs-12">
  <a href="plantas/create"><button class="btn btn-success">Nuevo</button></a>
</div>
</div>
...
<script type="text/javascript">
  jQuery(function($) {
    ...
    $('#table-plantas > thead > tr > th input[type=checkbox]').eq(0).on('click', function(){
    ...
    $('#table-plantas').on('click', 'td input[type=checkbox]' , function(){
      ...
      $(document).on('click', '#table-plantas .dropdown-toggle', function(e) {
